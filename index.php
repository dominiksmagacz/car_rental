...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Garaż <span class="caret"></span> </a>
                <ul class="dropdown-menu">
              <li> <a href="prereturncar.php">Oddaj auto</a></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: white">Wypożyczalnia aut</h1>
                            <p class="intro-text">
                                Internetowa wypożyczalnia aut
                            </p>
    ...
    <div id="sec2" style="color: #777;background-color:white;text-align:center;padding:50px 80px;text-align: justify;">
        <h3 style="text-align:center;">Obecnie dostępne auta</h3>
<br>
        <section class="menu-content">
            ...
            <h6> Ubezpieczenie: <?php echo ("PLN" . $ac_price . "/km & PLN" . $ac_price_per_day . "/day"); ?></h6>
            <h6> Brak ubezpieczenia: <?php echo ("PLN" . $non_ac_price . "/km & PLN" . $non_ac_price_per_day . "/day"); ?></h6>
...
<h1> Brak dostępnych aut :( </h1>
    ...
    <div style="position:relative;">
        <div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;">
            <p><a href="mybookings.php">Kliknij tutaj żeby zobaczyć ostatnie rezerwacje</a></p>
        </div>
    </div>
    <!-- Container (Contact Section) -->
    <div class="w3-content w3-container w3-padding-64" id="contact">
        <h3 class="w3-center">Gdzie pracujemy</h3>
        <p class="w3-center"><em>Podziel się opinią!</em></p>
        ...
        <div class="w3-row w3-padding-32 w3-section">
            ...
            <div class="w3-col m8 w3-panel">
                <div class="w3-large w3-margin-bottom">
                    <i class="fa fa-map-marker fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Katowice Polska<br>
                    <i class="fa fa-phone fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Telefon: +48 123123123<br>
                    <i class="fa fa-envelope fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Email: mail@o2.pl<br>
                </div>
                <p>Jesteś nowy, masz pytania, napisz do nas a się odezwiemy</p>
    ...
    <script>
        function myMap() {
            myCenter = new google.maps.LatLng(50.24176483770872, 19.050450091895264);
            var mapOptions = {
                center: myCenter,
                zoom: 12,
                scrollwheel: true,
