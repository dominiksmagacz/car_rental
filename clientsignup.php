            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="client_registered_success.php" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="client_name"><span class="text-danger" style="margin-right: 5px;">*</span> Imie i Nazwisko: </label>
                  ...
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-user" aria-hidden="true"></label>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="client_username"><span class="text-danger" style="margin-right: 5px;">*</span> Login: </label>
                                <div class="input-group">
                  ...
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                        ...
                        <label style="margin-left: 5px;"><a href="clientlogin.html">Masz już konto? Zaloguj się.</a></label>
