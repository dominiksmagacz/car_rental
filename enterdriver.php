 ...
 <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Wprowadź opis kierowcy </h3>

          <div class="form-group">
            <input type="text" class="form-control" id="driver_name" name="driver_name" placeholder="Imie oi nazwisko kierowcy " required autofocus="">
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="dl_number" name="dl_number" placeholder="Nr prawa jazdy" required>
          </div>     

          <div class="form-group">
            <input type="text" class="form-control" id="driver_phone" name="driver_phone" placeholder="Kontakt" required>
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="driver_address" name="driver_address" placeholder="Adres" required>
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="driver_gender" name="driver_gender" placeholder="Płeć" required>
          </div>

           <button type="submit" id="submit" name="submit" class="btn btn-primary pull-right"> Dodaj kierowce</button>    
        </form>
      </div>
    </div>
    ...
    <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Moi kierowcy </h3>
<?php
// Storing Session
...
if (mysqli_num_rows($result) > 0) {
  ...
  <h4><center>0 Dostępni kierowcy</center> </h4>
