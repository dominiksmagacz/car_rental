...
?>
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        ...
        <div class="container">
            <div class="jumbotron">
                <h1>Witaj w wypożyczalni aut </span>
                </h1>
                <br>
                ...
                <label class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-4">
                                    <button class="btn btn-primary" name="submit" type="submit" value=" Login ">Wyślij</button>

                                </div>

                            </div>
                            <label style="margin-left: 5px;">albo</label> <br>
                            <label style="margin-left: 5px;"><a href="customersignup.php">Stwórz nowe konto.</a></label>
                        </form>
                    </div>
                </div>
            </div>
