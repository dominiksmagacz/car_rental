...
<div class="container">
      <div class="jumbotron">
        ...
        <p> Mamy nadzieje że jesteś zadowolony z naszych usług </p>
      </div>
    </div>
...
<?php        } ?>
        ...
        <div class="container">
      <div class="jumbotron">
        <h1>Nie masz żadnego auta</h1>
        <p> Wypożycz jakieś auto teraz <?php echo $conn->error; ?> </p>
      </div>
    </div>
