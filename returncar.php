    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Garaż <span class="caret"></span> </a>
                <ul class="dropdown-menu">
              <li> <a href="returncar.php">Zwróć auto</a></li>
...
?>
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 5px; text-align: center; font-size: 30px;"> Szczegóły rezerwacji </h3>
          <h6 style="margin-bottom: 25px; text-align: center; font-size: 12px;"> Pozwól kierowcy wypełnić poniższy formularz </h6>

           <h5> Marka:&nbsp;  <?php echo($car_name);?></h5>

           <h5> Nr rejestracyjny:&nbsp;  <?php echo($car_nameplate);?></h5>

           <h5> Data początku rezerwacji:&nbsp;  <?php echo($rent_start_date);?></h5>

           <h5> Data końca rezerwacji:&nbsp;  <?php echo($rent_end_date);?></h5>
           ...
           <h5> Nazwa kierowcy:&nbsp;  <?php echo($driver_name);?></h5>

           <h5> Kontakt do kierowcy:&nbsp;  <?php echo($driver_phone);?></h5>
          <?php if($charge_type == "km") { ?>
          <div class="form-group">
            <input type="text" class="form-control" id="distance_or_days" name="distance_or_days" placeholder="Podaj dystans jaki przejechano" required="" autofocus>
          </div>
          <?php }  else { ?>
            <h5> Liczba dni rezerwacji:&nbsp;  <?php echo($no_of_days);?></h5>
            <input type="hidden" name="distance_or_days" value="<?php echo $no_of_days; ?>">
          <?php } ?>
          <input type="hidden" name="hid_fare" value="<?php echo $fare; ?>">

           <input type="submit" name="submit" value="Wyślij" class="btn btn-success pull-right">    
        </form>
      </div>
    </div>
