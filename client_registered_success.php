...
$hash_client = md5($client_password);

$query = "INSERT into clients(client_name,client_username,client_email,client_phone,client_address,client_password) VALUES('" . $client_name . "','" . $client_username . "','" . $client_email . "','" . $client_phone . "','" . $client_address ."','" . $hash_client ."')";
...
<div class="container">
	<div class="jumbotron" style="text-align: center;">
		...
		<p>Zaloguj się teraz <a href="clientlogin.php">Tutaj</a></p>
	</div>
</div>
